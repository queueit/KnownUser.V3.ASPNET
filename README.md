...
So, if you add the KnownUser validation logic to a central place like in Global.asax, the be sure that the Triggers only fire on page requests and not on e.g. image or ajax requests.
